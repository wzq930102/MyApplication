...
import com.jtvr.utils.InstallAPK;
...
public class DownloadAPKService extends Service {
    ...
    private DownloadListener listener = new DownloadListener() {
        ...
        public void onSuccess() {
            ...
            InstallAPK.installApk(file, DownloadAPKService.this);
        }
        ...
        public void onFailed() {
            ...
            Toast.makeText(DownloadAPKService.this, "下载失败", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onPaused() {
            downloadTask = null;
            Toast.makeText(DownloadAPKService.this, "暂停下载", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onCanceled() {
            ...
            stopForeground(true);
            Toast.makeText(DownloadAPKService.this, "取消下载", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    public class DownloadBinder extends Binder {
        ...
        public void startDownload(String url) {
            if (downloadTask == null) {
                ...
                startForeground(1, getNotification("正在下载", 0, 0, 0));
                Toast.makeText(DownloadAPKService.this, "正在下载", Toast.LENGTH_SHORT).show();
            }
