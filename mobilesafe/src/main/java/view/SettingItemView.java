...
public class SettingItemView extends RelativeLayout {
    private static final String NAMESPACE = "http://schemas.android.com/apk/res/com.example.mobilesafe.Activity";
    ...
    public SettingItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        //xml-->view  将设置界面的一个条目转换成view对象,直接添加到了当前SettingItemView中
        //
